...
/*
  ...
  Vendored verbatim from the upstream source (dynamic WebGL classes), adapted
  only to TSX: "use client", the CSS lives in globals.css (.liquid-ether-container),
  and type/lint checking is disabled for this third-party file. Used as the
  animated backdrop of the About poster's teal band.
*/
